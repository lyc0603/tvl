...
from environ.constants import CORR_NAMING_DICT
from scripts.process.fred_data import df_fred
...
from scripts.process.market_data import df_market
...
df_corr = df_corr[df_corr["date"] >= "2019-07-01"]
...
df_corr = df_corr.astype(float).dropna()
